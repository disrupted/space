...
public class Game 
{
    ...
    private Item keycardLvl1, keycardLvl2, map, picture;
    ...
    {
        keycardLvl1 = new Item("keycardLvl1", "you can unlock security level 1 hatches with it");
        keycardLvl2 = new Item("keycardLvl2", "you can unlock security level 2 hatches with it");
